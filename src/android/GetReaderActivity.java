...
//            	values[nCount] = readers.get(nCount).GetDescription().serial_number;
...
//      				setResult(Activity.RESULT_OK, new Intent().putExtra("serial_number", readers.get(position).GetDescription().serial_number));
    				finish();   
            	  }
            	});          	
        }
